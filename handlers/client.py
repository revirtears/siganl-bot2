...
- При регистрации введите промокод который даст +500% к депозиту, инструкция по регистрации ниже 👇""",
            ...
            warning_image_path = "photo/warning.png"
            warning_photo = FSInputFile(warning_image_path)

            warning_message = """
<b>⚠️ Ошибка: Регистрация не пройдена!

✦ При регистрации обязательно вводите промокод - MEGAslot500


● После завершения регистрации, Вам автоматически придет уведомление в бота</b>
"""
